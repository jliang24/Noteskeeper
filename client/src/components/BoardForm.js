  ...
  renderForm() {
    return (
      <div className="form-group">
        <form onSubmit={this.props.handleSubmit(values => { this.onSave(values)})}>
          <label className="col-form-label">What would you like to name this board?</label>
          <Field name="board" type="text" className="form-control" component={formComponent}/>
        </form>
     </div>
    )
  }
